...
tinaos:
	...
	$(GCC) -c src/kernel/kernel.c -Isrc/include -Isrc/include/newlib/include -Isrc/include/newlib/lib-o output/kernel.o -c font.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
